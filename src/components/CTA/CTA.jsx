      ...
      <div className="max-w-[1320px] mx-auto px-6 lg:px-10 relative z-10">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-gold text-forest-deeper px-12 py-5 text-base font-bold tracking-wide transition-all duration-300 hover:bg-gold-light hover:scale-105 shadow-lg"
