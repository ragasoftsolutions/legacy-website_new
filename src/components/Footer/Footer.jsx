  ...
  return (
    <footer className="bg-forest-darkest border-t border-white/8">
      <div className="max-w-[1320px] mx-auto px-6 lg:px-10 py-16 lg:py-20">
              ...
              {[{ icon: Linkedin, label: 'LinkedIn' }, { icon: Facebook, label: 'Facebook' }, { icon: X, label: 'X (Twitter)' }, { icon: Instagram, label: 'Instagram' }].map((social, i) => {
                ...
                return (
                  <motion.a
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.3, delay: 0.3 + i * 0.1, type: "spring", stiffness: 200 }}
        ...
        {/* Bottom Bar */}
        <motion.div 
          className="border-t border-white/8 pt-7 flex flex-col sm:flex-row justify-between items-center gap-3"
