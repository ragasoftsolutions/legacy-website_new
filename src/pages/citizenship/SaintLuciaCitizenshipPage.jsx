...
const benefits = [
  {
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 12L3.269 3.126A59.768 59.768 0 0121485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5" />
      </svg>
    ),
  ...
  return (
    <div className="bg-white">
      <PageBanner
        ...
        subtitle="Caribbean's Most Flexible CBI Program"
        breadcrumb={[
          { label: 'Home', href: '/' },
          { label: 'Citizenship By Investment', href: '/citizenship/saint-lucia' },
          { label: 'Saint Lucia', href: '/citizenship/saint-lucia' },
        ]}
        image={BANNER_IMG}
        overlay={0.7}
      />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal>
              <div>
                ...
                >
                  Saint Lucia offers one of the most flexible citizenship-by-investment programs in the Caribbean. Known for its beautiful landscapes and favorable tax regime, it's an attractive destination for investors.
                </motion.p>
                <motion.p
                ...
                >
                  The program offers multiple investment options including real estate, government bonds, and enterprise projects, allowing applicants to choose the route that best suits their needs.
                </motion.p>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
