  ...
  return (
    <div className="bg-white">
      <PageBanner
        ...
        subtitle="Fastest Citizenship in the World"
        breadcrumb={[
          { label: 'Home', href: '/' },
          { label: 'Citizenship By Investment', href: '/citizenship/vanuatu' },
          { label: 'Vanuatu', href: '/citizenship/vanuatu' },
        ]}
        image={BANNER_IMG}
        overlay={0.7}
      />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal>
              <div>
                ...
                >
                  Vanuatu offers one of the fastest citizenship-by-investment programs in the world, with processing times as quick as 30 days. Located in the South Pacific, Vanuatu provides an attractive option for those seeking a second citizenship.
                </motion.p>
                <motion.p
                ...
                >
                  The Vanuatu Citizenship by Investment Program offers visa-free access to over 130 countries, including the UK, EU Schengen area, and Singapore.
                </motion.p>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
